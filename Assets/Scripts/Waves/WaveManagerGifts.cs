...
public class WaveManagerGifts : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // Se o jogador quer interagir com o presente, pode usar um m�todo aqui para verificar a posi��o do highlight
    ...
    private IEnumerator ProcessWave()
    {
        ...
        // Inicia a wave rand�mica
        yield return StartCoroutine(SpawnGiftWave());

        // Espera todos os presentes sumirem (chegar ao fim ou serem destru�dos)
    ...
    {
        // Verifica se o player est� interagindo com o slot do presente
